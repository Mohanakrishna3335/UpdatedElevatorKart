...
public class Elevators {
	...
	public void initStoreItems() {
		...
		int[] stock = { 72, 65, 45 };
		String[] elevatorFeatures = { "1. people count 2.temperature measure",
				"1. people count 2.temperature measure 3.speed of the elevator 4.tensile strength of elevator",
				"1.people count 2.temperature measure 3.speed of the elevator 4.tensile strength of elevator ,5.firedetection 6. level of elevator" };
